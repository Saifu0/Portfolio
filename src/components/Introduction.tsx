...
function Introduction() {
    return (
        <div className="navbar navbar-expand" style={{ marginTop : 20 }}>
            ...
            <div className="intro" style={{marginLeft : 20}} >
                Hi, I'm Saifur Rehman. I'm a Software Developer and Competitive Programmer(atleast I claim). I like to build full-stack applications,
